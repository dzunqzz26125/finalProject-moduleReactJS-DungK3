    ...
    >
      ...
      <div className="flex items-center gap-3 ml-auto flex-wrap">
        <div className="relative">
          <span
            className="material-symbols-outlined absolute left-2 top-5.5 -translate-y-1/2 text-[14px]"
            style={{ color: "var(--text-muted)" }}
          >
            search
          </span>
        ...
        <select
          ...
          className="border focus:ring-0 py-1.5 text-xs uppercase transition-colors"
          style={{
            backgroundColor: "var(--bg-elevated)",
            borderColor: "var(--border)",
            color: "var(--text-primary)",
