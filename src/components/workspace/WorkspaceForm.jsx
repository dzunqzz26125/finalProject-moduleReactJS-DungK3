...
const WorkspaceForm = ({ onClose, workspace }) => {
  ...
  const onSubmit = async (data) => {
    if (isEdit) {
      ...
      await api.post("/workspace_members", {
    ...
    <div className="fixed inset-0 z-60 flex items-center justify-center p-4">
      ...
      <div className="relative bg-[#1C1B1B] border-2 border-[#CCFF00] w-full max-w-md shadow-[0_0_50px_rgba(204,255,0,0.1)]">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="p-6 space-y-5">
          <div>
            <label className="text-[#CCFF00] text-[10px] uppercase tracking-widest block mb-2">
              Name *
            </label>
            <input
                ...
                <label key={c} className="cursor-pointer">
                  ...
                  <div
                    ...
                    style={{
                      backgroundColor: c,
                      outline:
                        selectedColor === c ? "3px solid #CCFF00" : "none",
                      outlineOffset: "2px",
                    }}
                  />
                </label>
          ...
          <button
            type="submit"
            className="w-full bg-[#CCFF00] text-[#131313] font-black py-3 uppercase tracking-wider font-['Space_Grotesk'] hover:bg-[#ABD600] transition-colors"
          >
